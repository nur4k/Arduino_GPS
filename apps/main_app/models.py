...
class Item(models.Model):
    ...
    latitude = models.DecimalField(verbose_name='Широта', max_digits=9, decimal_places=6,null=True, blank=True)  # Широта
    longitude = models.DecimalField(verbose_name='Долгота', max_digits=9, decimal_places=6, null=True, blank=True)  # Долгота
    direction = models.DecimalField(verbose_name='Направление', max_digits=5, decimal_places=2, null=True, blank=True)  # Направление
    speed = models.DecimalField(verbose_name='Скорость', max_digits=5, decimal_places=2, null=True, blank=True)  # Скорость
